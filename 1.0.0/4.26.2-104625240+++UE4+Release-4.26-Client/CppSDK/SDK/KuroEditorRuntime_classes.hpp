...
class UCommandService final : public UObject
{
public:
	...
	uint8                                         Pad_1777[0x30];                                    // 0x0040(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UCommandService) == 0x000008, "Wrong alignment on UCommandService");
