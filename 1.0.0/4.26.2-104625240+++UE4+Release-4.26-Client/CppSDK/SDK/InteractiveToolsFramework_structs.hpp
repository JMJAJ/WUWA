...
{
public:
	uint8                                         Pad_25C1[0xB4];                                    // 0x0000(0x00B4)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBrushStampData) == 0x000004, "Wrong alignment on FBrushStampData");
static_assert(sizeof(FBrushStampData) == 0x0000B4, "Wrong size on FBrushStampData");
...
public:
	...
	uint8                                         Pad_25C2[0x18];                                    // 0x0008(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_25C3[0x28];                                    // 0x0000(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_25C4[0x30];                                    // 0x0000(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
