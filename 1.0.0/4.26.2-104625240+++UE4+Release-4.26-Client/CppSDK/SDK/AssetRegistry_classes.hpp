...
{
public:
	uint8                                         Pad_2530[0x790];                                   // 0x0030(0x0790)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool IsPathsForceScanned(const TArray<class FString>& InPaths);
	...
	bool IsAssetPathLoaded(class FString* Path) const;
