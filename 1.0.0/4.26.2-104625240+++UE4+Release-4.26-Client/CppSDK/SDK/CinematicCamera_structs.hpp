...
public:
	...
	uint8                                         Pad_2521[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2522[0x10];                                    // 0x0008(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2523[0x3];                                     // 0x0055(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCameraLookatTrackingSettings) == 0x000008, "Wrong alignment on FCameraLookatTrackingSettings");
static_assert(sizeof(FCameraLookatTrackingSettings) == 0x000058, "Wrong size on FCameraLookatTrackingSettings");
...
public:
	...
	uint8                                         Pad_2524[0x3];                                     // 0x003D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCameraTrackingFocusSettings) == 0x000008, "Wrong alignment on FCameraTrackingFocusSettings");
static_assert(sizeof(FCameraTrackingFocusSettings) == 0x000040, "Wrong size on FCameraTrackingFocusSettings");
...
public:
	...
	uint8                                         bDrawDebugFocusPlane : 1;                          // 0x0048(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_2526[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         bUseForegroundBlur : 1;                            // 0x0050(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_2527[0x3];                                     // 0x0051(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2528[0x4];                                     // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FCameraFocusSettings, DebugFocusPlaneColor) == 0x00004C, "Member 'FCameraFocusSettings::DebugFocusPlaneColor' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2529[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
