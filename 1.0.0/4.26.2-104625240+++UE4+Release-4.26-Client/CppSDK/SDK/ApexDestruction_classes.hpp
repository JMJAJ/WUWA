...
public:
	...
	uint8                                         Pad_2260[0x7];                                     // 0x07D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2261[0x3];                                     // 0x07E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2262[0x10];                                    // 0x07F0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2263[0xA0];                                    // 0x0810(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2265[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2266[0x4];                                     // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2267[0x28];                                    // 0x0098(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FDestructibleParameters                DefaultDestructibleParameters;                     // 0x0420(0x0088)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FFractureEffect>                FractureEffects;                                   // 0x04A8(0x0010)(Edit, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
	class UStaticMesh*                            StaticMeshProxy;                                   // 0x04B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2268[0x8];                                     // 0x04C0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDestructibleMesh) == 0x0004C8, "Wrong size on UDestructibleMesh");
static_assert(offsetof(UDestructibleMesh, DefaultDestructibleParameters) == 0x000420, "Member 'UDestructibleMesh::DefaultDestructibleParameters' has a wrong offset!");
static_assert(offsetof(UDestructibleMesh, FractureEffects) == 0x0004A8, "Member 'UDestructibleMesh::FractureEffects' has a wrong offset!");
static_assert(offsetof(UDestructibleMesh, StaticMeshProxy) == 0x0004B8, "Member 'UDestructibleMesh::StaticMeshProxy' has a wrong offset!");
