...
public:
	...
	uint8                                         Pad_1D6C[0x4];                                     // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1D6D[0x10];                                    // 0x0030(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1D6F[0x8];                                     // 0x0050(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D70[0x6];                                     // 0x009A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	class USMStateInstance_Base* GetNextStateByTransitionIndex(int32 Param_Index) const;
	...
	class USMTransitionInstance* GetTransitionByIndex(int32 Param_Index) const;
...
static_assert(sizeof(USMStateInstance_Base) == 0x0000E8, "Wrong size on USMStateInstance_Base");
...
{
public:
	bool                                          bEvalWithTransitions;                              // 0x00E8(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCanEvaluate;                                      // 0x00E9(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D79[0x6];                                     // 0x00EA(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USMConduitInstance) == 0x0000F0, "Wrong size on USMConduitInstance");
static_assert(offsetof(USMConduitInstance, bEvalWithTransitions) == 0x0000E8, "Member 'USMConduitInstance::bEvalWithTransitions' has a wrong offset!");
static_assert(offsetof(USMConduitInstance, bCanEvaluate) == 0x0000E9, "Member 'USMConduitInstance::bCanEvaluate' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1D7A[0x38];                                    // 0x0030(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D7B[0x140];                                   // 0x0130(0x0140)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D7C[0x3];                                     // 0x0521(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D7D[0x10];                                    // 0x0528(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D7E[0x3];                                     // 0x054D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USMStateInstance) == 0x0000E8, "Wrong size on USMStateInstance");
...
{
public:
	uint8                                         Pad_1D90[0x10];                                    // 0x00C0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D91[0x24];                                    // 0x0190(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D92[0x3];                                     // 0x01B5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D93[0x3];                                     // 0x01C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D94[0x3];                                     // 0x01D5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D95[0x8];                                     // 0x01E8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D96[0x3];                                     // 0x0201(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetCanInstanceNetworkTick(bool Param_bCanEverTick);
	void Shutdown();
	void Start();
	void Stop();
	void Update(float DeltaSeconds);
...
{
public:
	TArray<class USMStateInstance_Base*>          Children;                                          // 0x00E8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class USMTransitionInstance*>          TransitionList;                                    // 0x00F8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D98[0x8];                                     // 0x0108(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USMStateMachineInstance) == 0x000110, "Wrong size on USMStateMachineInstance");
static_assert(offsetof(USMStateMachineInstance, Children) == 0x0000E8, "Member 'USMStateMachineInstance::Children' has a wrong offset!");
static_assert(offsetof(USMStateMachineInstance, TransitionList) == 0x0000F8, "Member 'USMStateMachineInstance::TransitionList' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1D99[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D9A[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D9B[0x7];                                     // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
