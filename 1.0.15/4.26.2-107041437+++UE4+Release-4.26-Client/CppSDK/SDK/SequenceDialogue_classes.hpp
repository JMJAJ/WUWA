...
static_assert(sizeof(UMovieSceneAutoTransformSection) == 0x0000F0, "Wrong size on UMovieSceneAutoTransformSection");
...
{
public:
	uint8                                         Pad_2239[0x8];                                     // 0x0080(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class FString                                 AudioKey;                                          // 0x00F0(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         AudioTransitionDuration;                           // 0x0100(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_223A[0x4];                                     // 0x0104(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneDialogueAudioSection) == 0x000108, "Wrong size on UMovieSceneDialogueAudioSection");
static_assert(offsetof(UMovieSceneDialogueAudioSection, AudioKey) == 0x0000F0, "Member 'UMovieSceneDialogueAudioSection::AudioKey' has a wrong offset!");
static_assert(offsetof(UMovieSceneDialogueAudioSection, AudioTransitionDuration) == 0x000100, "Member 'UMovieSceneDialogueAudioSection::AudioTransitionDuration' has a wrong offset!");
...
{
public:
	uint8                                         Pad_223B[0x8];                                     // 0x0080(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x0088(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
{
public:
	class FText                                   DialogueInfo;                                      // 0x00F0(0x0018)(Edit, NativeAccessSpecifierPrivate)
	int32                                         Index_MovieSceneDialogueSection;                   // 0x0108(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_223C[0x4];                                     // 0x010C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   SpeakerName;                                       // 0x0110(0x0018)(Edit, NativeAccessSpecifierPrivate)
	int32                                         SpeakerID;                                         // 0x0128(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_223D[0x4];                                     // 0x012C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   DialogueID;                                        // 0x0130(0x0018)(Edit, NativeAccessSpecifierPrivate)
	TArray<class FText>                           DialogueInfos;                                     // 0x0148(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class FText>                           OptionInfos;                                       // 0x0158(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	int32                                         GuardTime;                                         // 0x0168(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         AudioDelay;                                        // 0x016C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         AudioTransitionDuration;                           // 0x0170(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_223E[0x4];                                     // 0x0174(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneDialogueSection) == 0x000178, "Wrong size on UMovieSceneDialogueSection");
static_assert(offsetof(UMovieSceneDialogueSection, DialogueInfo) == 0x0000F0, "Member 'UMovieSceneDialogueSection::DialogueInfo' has a wrong offset!");
static_assert(offsetof(UMovieSceneDialogueSection, Index_MovieSceneDialogueSection) == 0x000108, "Member 'UMovieSceneDialogueSection::Index_MovieSceneDialogueSection' has a wrong offset!");
static_assert(offsetof(UMovieSceneDialogueSection, SpeakerName) == 0x000110, "Member 'UMovieSceneDialogueSection::SpeakerName' has a wrong offset!");
static_assert(offsetof(UMovieSceneDialogueSection, SpeakerID) == 0x000128, "Member 'UMovieSceneDialogueSection::SpeakerID' has a wrong offset!");
static_assert(offsetof(UMovieSceneDialogueSection, DialogueID) == 0x000130, "Member 'UMovieSceneDialogueSection::DialogueID' has a wrong offset!");
static_assert(offsetof(UMovieSceneDialogueSection, DialogueInfos) == 0x000148, "Member 'UMovieSceneDialogueSection::DialogueInfos' has a wrong offset!");
static_assert(offsetof(UMovieSceneDialogueSection, OptionInfos) == 0x000158, "Member 'UMovieSceneDialogueSection::OptionInfos' has a wrong offset!");
static_assert(offsetof(UMovieSceneDialogueSection, GuardTime) == 0x000168, "Member 'UMovieSceneDialogueSection::GuardTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneDialogueSection, AudioDelay) == 0x00016C, "Member 'UMovieSceneDialogueSection::AudioDelay' has a wrong offset!");
static_assert(offsetof(UMovieSceneDialogueSection, AudioTransitionDuration) == 0x000170, "Member 'UMovieSceneDialogueSection::AudioTransitionDuration' has a wrong offset!");
...
{
public:
	struct FDialogueStateStruct                   SectionData;                                       // 0x00F0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_223F[0x7];                                     // 0x00F1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneDialogueStateSection) == 0x0000F8, "Wrong size on UMovieSceneDialogueStateSection");
static_assert(offsetof(UMovieSceneDialogueStateSection, SectionData) == 0x0000F0, "Member 'UMovieSceneDialogueStateSection::SectionData' has a wrong offset!");
...
{
public:
	uint8                                         Pad_2240[0x8];                                     // 0x0080(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x0088(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                         Pad_2241[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2242[0x10];                                    // 0x0060(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2243[0x18];                                    // 0x0080(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ShowDialogue(bool bShow, const class FText& DialogueID, const int32 GuardTime, const int32 AudioDelay, const int32 AudioTransitionDuration);
...
{
public:
	uint8                                         Pad_2249[0x8];                                     // 0x0080(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x0088(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneDialogueTrack) == 0x000098, "Wrong size on UMovieSceneDialogueTrack");
...
{
public:
	TArray<struct FFloatNameAndCurve>             FloatNamesAndCurves;                               // 0x00F0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FVectorNameAndCurve>            VectorNameAndCurves;                               // 0x0100(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneSeqAnimDataSection) == 0x000110, "Wrong size on UMovieSceneSeqAnimDataSection");
static_assert(offsetof(UMovieSceneSeqAnimDataSection, FloatNamesAndCurves) == 0x0000F0, "Member 'UMovieSceneSeqAnimDataSection::FloatNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneSeqAnimDataSection, VectorNameAndCurves) == 0x000100, "Member 'UMovieSceneSeqAnimDataSection::VectorNameAndCurves' has a wrong offset!");
...
{
public:
	uint8                                         Pad_224F[0x8];                                     // 0x0080(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x0088(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
