...
public:
	...
	uint8                                         Pad_2433[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2434[0x7];                                     // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(MobilePendingContent_StartInstall) == 0x000028, "Wrong size on MobilePendingContent_StartInstall");
...
static_assert(offsetof(MobilePendingContent_StartInstall, OnFailed) == 0x000014, "Member 'MobilePendingContent_StartInstall::OnFailed' has a wrong offset!");
...
public:
	...
	TDelegate<void(class UMobilePendingContent* MobilePendingContent)> OnSucceeded;                                       // 0x0030(0x0014)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(MobilePatchingLibrary_RequestContent) == 0x000058, "Wrong size on MobilePatchingLibrary_RequestContent");
...
static_assert(offsetof(MobilePatchingLibrary_RequestContent, OnFailed) == 0x000044, "Member 'MobilePatchingLibrary_RequestContent::OnFailed' has a wrong offset!");
